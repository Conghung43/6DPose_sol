...
public static class StationStageIndex
{
    ...
    // Indicates whether an model target has been found
    public static bool modelTargetFound;
    ...
    public static bool ModelTargetFound
    {
        get { return modelTargetFound; }
        set
        {
            if (value != modelTargetFound)
            {
                modelTargetFound = value;
                OnImageTargetFoundChange?.Invoke(modelTargetFound);
            }
        }
    }
